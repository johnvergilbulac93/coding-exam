...
<template>
  <Authenticated>
    <div class="flex justify-between items-center">
      <label for="" class="text-lg font-semibold text-gray-600">User List</label>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr v-for="(user, i) in users" :key="i">
          ...
          <td class="flex gap-2">
            <span @click="editUser(user)" class="font-medium text-indigo-600 hover:underline cursor-pointer">Edit</span>
            |
            <span @click="handleDelete(user.id)"
              class="font-medium text-indigo-600 hover:underline cursor-pointer">Delete</span>
          </td>
        </tr>
      </tbody>
    </table>
    <!-- <LaravelVuePagination :data="users" @pagination-change-page="showUser" /> -->
            ...
            <div class="flex justify-center items-center p-5 space-y-2">
              <div class="w-3/4">
                ...
                <div>
                  ...
                  <Input type="password" class="mt-1 block w-full" autocomplete="current-password"
                ...
                <div>
                  ...
                  <span v-if="errors.password_confirmation" class="text-xs text-red-500">{{
